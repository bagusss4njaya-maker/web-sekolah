...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold text-gray-800">Kelola Nilai Siswa</h2>
    <a href="{{ route('guru.grades.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Input Nilai
    </a>
</div>
            ...
            <tbody>
                ...
                <tr class="border-b last:border-0 hover:bg-gray-50">
                    <td class="p-4">
                        ...
                        <div class="text-xs text-gray-500">{{ $grade->student->nis }}</div>
                    </td>
                    ...
                    <td class="p-4">
                        <a href="{{ route('guru.grades.edit', $grade) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                        <form action="{{ route('guru.grades.destroy', $grade) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus nilai ini?');">
                            @csrf
                            @method('DELETE')
